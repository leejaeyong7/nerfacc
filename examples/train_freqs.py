...
if __name__ == "__main__":
    ...
    optimizer = torch.optim.Adam(radiance_field.mlp.parameters(), lr=3.5e-4)
    grid_optimizer = torch.optim.Adam(list(radiance_field.posi_encoder.parameters()) + list(radiance_field.view_encoder.parameters()), lr=9.5e-3, eps=1e-15)
