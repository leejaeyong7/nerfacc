...
def main(args):
    ...
    radiance_field = QFFRadianceField(net_depth=args.net_depth, 
                                      num_quants=args.num_quants, 
                                      num_features=args.num_features,
                                      qff_type=args.qff_type).to(device)

    ##############################################
    # Model optimizer / scheduling
...
if __name__ == "__main__":
    ...
    parser.add_argument( "--scene", type=str, default="lego", choices=nerf_synthetic_scenes, help="which scene to use")
    ...
    parser.add_argument( "--qff_type", type=int, choices=[1, 2, 3], help="QFF type")
